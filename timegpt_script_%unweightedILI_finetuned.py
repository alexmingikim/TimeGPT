...
def main():
    ...
    for horizon in horizons:
        ### Save forecasts
        # Define path
        output_dir = f"output/%UNWEIGHTED ILI/hyperparameter_tuning/{state}/{horizon}week/forecasts"
        ...
        # Define path
        eval_dir = f"output/%UNWEIGHTED ILI/hyperparameter_tuning/{state}/{horizon}week/evaluation"
