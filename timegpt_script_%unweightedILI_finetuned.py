...
def main():
    ...
    for horizon in horizons:
        ### Save forecasts
        # Define path
        output_dir = f"output/%UNWEIGHTED ILI/hyperparameter_tuning/100/{state}/{horizon}week/forecasts" #
        ...
        # Define path
        eval_dir = f"output/%UNWEIGHTED ILI/hyperparameter_tuning/100/{state}/{horizon}week/evaluation" #
